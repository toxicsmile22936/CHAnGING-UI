    ...
    <main className="portfolio-page">
        ...
        <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-3">
          {investmentGuide.map((item, idx) => (
            <motion.article
              ...
              className={`rounded-3xl border p-5 shadow-[0_16px_34px_rgba(176,191,244,0.14)] ${idx === 1
      ...
      <section id="contact" className="section-shell contact-section">
        ...
        >
          ...
          <a href="mailto:contact@eomeg.in" className="contact-email-link">
            <Mail size={16} /> contact@eomeg.in
          </a>
          <div className="socials">
            <a href="https://instagram.com/eomeg" className="social-pill" aria-label="Instagram" target="_blank" rel="noreferrer">
          ...
          <div className="grid grid-cols-1 gap-8 border-b border-[#d7e0ff]/70 pb-8 md:grid-cols-4">
            ...
            <div>
              ...
              <div className="mt-3 space-y-2 text-sm text-[#5a6a9a]">
                ...
                <a href="https://instagram.com/eomeg" className="block transition-colors hover:text-[#1f2856]" target="_blank" rel="noreferrer">Instagram</a>
                <a href="mailto:contact@eomeg.in?subject=Portfolio%20Request" className="block transition-colors hover:text-[#1f2856]">
                  Portfolio Deck
                </a>
              </div>
            </div>
